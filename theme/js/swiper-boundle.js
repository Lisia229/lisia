...
;(function (global, factory) {
    ...
    if (params.cssMode) {
      ...
      if (speed === 0) {
        ...
        if (wrapperEl.scrollTo) {
          ...
          wrapperEl.scrollTo(
            ((_wrapperEl$scrollTo = {}), (_wrapperEl$scrollTo[isH ? 'left' : 'top'] = t), (_wrapperEl$scrollTo.behavior = 'smooth'), _wrapperEl$scrollTo)
          )
        } else {
          wrapperEl[isH ? 'scrollLeft' : 'scrollTop'] = t
        }
  ...
  var Scrollbar = {
    ...
    setDragPosition: function setDragPosition(e) {
      ...
      var positionRatio
      positionRatio =
        (scrollbar.getPointerPosition(e) - $el.offset()[swiper.isHorizontal() ? 'left' : 'top'] - (dragStartPos !== null ? dragStartPos : dragSize / 2)) /
        (trackSize - dragSize)
